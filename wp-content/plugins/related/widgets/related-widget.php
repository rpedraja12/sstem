...
class Related_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'related_widget', 'description' => __('Displays Related Posts.','related') );
		parent::__construct('related_widget', __('Related Posts','related'), $widget_ops);

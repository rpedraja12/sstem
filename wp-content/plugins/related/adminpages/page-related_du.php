					...
					<form name="related_options_page_content" action="" method="POST">
						...
						<ul>
							...
							<li>
								...
								<label for="related_du_content_title"><?php _e('Title to show above the related posts: ', 'related'); ?><br />
									<input name="related_du_content_title" type="text" id="related_du_content_title" value="<?php echo esc_attr(stripslashes(get_option('related_du_content_title', __('Related Posts', 'related')))); ?>" />
								</label>
							</li>
							<li>
